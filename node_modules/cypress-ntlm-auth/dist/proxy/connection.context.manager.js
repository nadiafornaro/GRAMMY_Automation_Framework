...
let ConnectionContextManager = class ConnectionContextManager {
    constructor(upstreamProxyManager, connectionContext, httpsValidation, debug) {
    ...
    getAgent(isSSL, targetHost, useUpstreamProxy) {
        const agentOptions = {
            keepAlive: true,
            maxSockets: 1,
        ...
        if (useUpstreamProxy && isSSL) {
            agent = (0, tunnel_agent_1.httpsTunnel)(agentOptions);
        }
        else {
            agent = isSSL
...
ConnectionContextManager = __decorate([
    ...
    __param(0, (0, inversify_1.inject)(dependency_injection_types_1.TYPES.IUpstreamProxyManager)),
    __param(1, (0, inversify_1.inject)(dependency_injection_types_1.TYPES.NewableIConnectionContext)),
    __param(2, (0, inversify_1.inject)(dependency_injection_types_1.TYPES.IHttpsValidation)),
