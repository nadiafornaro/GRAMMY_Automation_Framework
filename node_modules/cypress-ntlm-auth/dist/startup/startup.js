...
Startup = __decorate([
    ...
    __param(0, (0, inversify_1.inject)(dependency_injection_types_1.TYPES.IUpstreamProxyConfigurator)),
    __param(1, (0, inversify_1.inject)(dependency_injection_types_1.TYPES.IMain)),
    __param(2, (0, inversify_1.inject)(dependency_injection_types_1.TYPES.ICypressFacade)),
    __param(3, (0, inversify_1.inject)(dependency_injection_types_1.TYPES.IEnvironment)),
    __param(4, (0, inversify_1.inject)(dependency_injection_types_1.TYPES.INtlmProxyFacade)),
    __param(5, (0, inversify_1.inject)(dependency_injection_types_1.TYPES.IDebugLogger)),
